...
/**
 * Turns exceptions into the standard {@link ApiResponseDto} error envelope so
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponseDto<Void>> handleMaxUpload(MaxUploadSizeExceededException e) {
    ...
    private ResponseEntity<ApiResponseDto<Void>> error(HttpStatus status, String code, String message) {
        return ResponseEntity.status(status).body(ApiResponseDto.error(code, message));
    }
}
